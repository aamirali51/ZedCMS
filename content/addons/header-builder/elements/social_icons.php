...
$socials = [
    'twitter' => zed_get_theme_option('social_twitter', ''),
    'facebook' => zed_get_theme_option('social_facebook', ''),
    'instagram' => zed_get_theme_option('social_instagram', ''),
    'youtube' => zed_get_theme_option('social_youtube', ''),
    'linkedin' => zed_get_theme_option('social_linkedin', ''),
];
...
?>
<div class="hb-el-social flex items-center gap-2">
    <?php foreach ($socials as $network => $url): ?>
        <?php if (!empty($url)): ?>
        <a href="<?= htmlspecialchars($url) ?>" target="_blank" rel="noopener" 
           class="w-8 h-8 flex items-center justify-center text-gray-500 hover:text-indigo-600 dark:text-gray-400 dark:hover:text-indigo-400 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors">
            <?= $icons[$network] ?? '' ?>
        </a>
        <?php endif; ?>
    <?php endforeach; ?>
